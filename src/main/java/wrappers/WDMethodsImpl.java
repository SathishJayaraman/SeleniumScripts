...
public interface WDMethodsImpl {
	 ...
	 * 
	 * @param locatortype-
	 *            Locator types to be used are id, xpath, className, name,
	 *            tagName, linkText, partialLinkText, cssSelector
	 * @param locator-
	 *            locator is the web element to be passed in this method
	 ...
	 * 
	 * @param element-
	 *            Element is the webelement for the field on which value is to
	 *            be passed
	 * @param input-
	 *            Input is the string/integer/float value to be passed in the
	 *            text field
	 * @author Lakshminarayanan
	 */
	...
	/**
	 * This method is used to select a value from the dropdown using the
	 * visibletext in dropdown
	 * 
	 * @param element-
	 *            name of the webelement
	 * @param text-
	 *            Visible text present in the dropdown
	 * @author Lakshminarayanan
	 */
	public void selectByVisibleText(WebElement element, String text);

	/**
	 * This method is used to select a value from the dropdown using the index
	 * value in dropdown
	 * 
	 * @param element-
	 *            name of the webelement
	 * @param index-
	 *            Index value of the dropdown
	 * @author Lakshminarayanan
	 */
	public void selectByIndex(WebElement element, int index);

	/**
	 * This method is used to select a value from the dropdown using the value
	 * value in dropdown
	 * 
	 * @param element-
	 *            name of the webelement
	 * @param value-
	 *            Value of the element in dropdown
	 * @author Lakshminarayanan
	 */
	public void selectByValue(WebElement element, String value);

	/**
	 * This method is used to switch to any particlar window if there are
	 * multiple window sessions opened
	 * 
	 * @param window-
	 *            window size/value
	 * @author Lakshminarayanan
	...
	/**
	 * This method is used to accept an alert if it is present in the web
	 * browser
	 * 
	 * @author Lakshminarayanan
	 */
	...
	/**
	 * This method is used to switch inside a frame if it is present in a web
	 * page
	 * 
	 * @param element-
	 ...
	 * 
	 * @param title-
	 *            Input value of the title which is compared with the value
	 ...
	 *            name of the web element
	 * @param vertext-
	 *            Input text given for comparing with text retrieved from web
	 *            page
